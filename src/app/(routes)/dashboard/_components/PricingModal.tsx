...
function PricingModal() {
  return (
    <DialogContent className="max-w-4xl">
      <DialogHeader className="max-w-[48rem] mx-auto  ">
        <DialogTitle className="text-[20px] md:text-[22px]">Upgrade Plan</DialogTitle>
        <DialogDescription>
          <div className="w-full py-[10px] md:py-[12px]">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8 ">
              <div className="rounded-2xl h-[100%] border border-indigo-600 p-6 shadow-sm ring-1 ring-indigo-600 sm:order-last sm:px-8 lg:p-12">
         ...
         bg-indigo-600 px-12 py-3 text-center text-sm font-medium text-white hover:bg-indigo-700 hover:ring-1 hover:ring-indigo-700 focus:outline-none focus:ring active:text-indigo-500"
              ...
              <div className="rounded-2xl h-[100%] border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
                <div className="text-center">
                  <h2 className="text-lg font-medium text-gray-900">
                    Free
                    <span className="sr-only">Plan</span>
      ...
      <DialogFooter className="">
        <DialogClose className="w-[20px] text-[20px]" asChild></DialogClose>
      </DialogFooter>
    </DialogContent>
  );
}
